...
Provides detailed process variant statistics including summary metrics,
a sortable variant table with cumulative percentages, bar/pie charts,
a variant detail viewer, and CSV download.
"""
...
display_df.index = display_df.index + 1  # 1-based index for display
...
# ---------------------------------------------------------------------------
# Bar chart -- top 20 variants
# ---------------------------------------------------------------------------
st.subheader("Top 20 Variants")
...
# Group smaller variants into "Other" for a cleaner pie chart
PIE_LIMIT = 10
...
# Show a short preview in the selectbox
variant_previews = [

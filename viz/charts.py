...
def build_variant_explorer_html(
    ...
    for i, (_, row) in enumerate(df.iterrows()):
        ...
        for act in activities:
            ...
            chevrons.append(
                f'<span class="chv" style="background:{bg}" title="{safe}"></span>'
            )
...
.vchv{{flex:1;display:flex;align-items:center}}

.chv{{height:24px;flex:1 1 0;min-width:18px;max-width:70px;
